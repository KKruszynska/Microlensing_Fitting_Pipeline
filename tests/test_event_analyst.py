    ...
    "config_final" : {
        ...
        "cmd_analyst":
            {"catalogues":
                 [{"name": "Gaia_DR3",
                   "band": ["Gaia_G", "Gaia_BP", "Gaia_RP"],
                   "cmd_path": "../Microlensing_Fitting_Pipeline/tests/test_cmd/input/gdr3-ulens-025_result.csv",
                   "cmd_separator": ","},
                  {"name": "Gaia_DR2",
                   "band": ["Gaia_G", "Gaia_BP", "Gaia_RP"],
                   "cmd_path": "../Microlensing_Fitting_Pipeline/tests/test_cmd/input/gdr3-ulens-025_result.csv",
...
class testEventAnalyst:
    ...
    def test_parse_config(self):
        ...
        event_analyst = EventAnalyst(event_name, analyst_path, config_path=analyst_path+"config.yaml")
